...
public class EAF_BPO_NEW extends ExtendReports{
  ...
  public void launchijp() {                               
                                ...
                                String scrFolder = System.getProperty("user.dir")+"\\Screenshots\\EAF_BPO_directApplicant\\"+ new SimpleDateFormat("dd_MM_yyyy_HHmmss").format(Calendar.getInstance().getTime()).toString();
  ...
  @Test
                ...
                */
                                   ...
                                   wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.lnk_faq_bpo(driver)));
                                   PageObjectsEAF.lnk_faq_bpo(driver).click();
                                   
                                   ArrayList<String> tabs2 = new ArrayList<String> (driver.getWindowHandles());
                                    driver.switchTo().window(tabs2.get(1));
                                       
                                                Thread.sleep(5000);
//                                            wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.lnk_download_faq_bpo(driver)));
//                                            wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.lnk_download_faq_bpo(driver)));
//                                            PageObjectsEAF.lnk_download_faq_bpo(driver).click();
                                                Thread.sleep(5000);
                                                                                
                                                Robot faq = new Robot();             
                                                faq.keyPress(KeyEvent.VK_CONTROL);
                                                faq.keyPress(KeyEvent.VK_S);
                                                faq.keyPress(KeyEvent.VK_S);
                                                faq.keyPress(KeyEvent.VK_CONTROL);
                                                Thread.sleep(3000);
                                                faq.keyPress(KeyEvent.VK_ENTER);
                                                faq.keyRelease(KeyEvent.VK_ENTER);
           ...
           robot.keyRelease(KeyEvent.VK_ENTER);
                                   ...
                                   jse.executeScript("arguments[0].scrollIntoView()", PageObjectsEAF.dd_fname(driver));
                                   Thread.sleep(3000);
                                ...
                                System.out.println(Gender1);
                                   if(Gender1.isEmpty()){
                                                   ...
                                                   Thread.sleep(2000);
                                                   PageObjectsEAF.dd_gender_input(driver).sendKeys(data.gender);
                ...
                */             
                       ...
                       Thread.sleep(3000);
                                  ...
                                  PageObjectsEAF.txt_place_of_birth(driver).sendKeys(data.place_of_birth);
                                   ...
                                   jse.executeScript("arguments[0].click();", PageObjectsEAF.dd_citizenship(driver));
                                   Thread.sleep(3000);
                ...
                */                          
                       ...
                       wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_pref_location_bpo(driver)));                
                                   ...
                                   Thread.sleep(3000);
                                   jse.executeScript("arguments[0].scrollIntoView()", PageObjectsEAF.btm_navigator_poip(driver));
                                   Thread.sleep(3000);
               ...
               */          
                       ...
                       Thread.sleep(3000);
                                   ...
                                   if(pancard1.contains("Yes")){
                                	   String PAN_NUMBER =PageObjectsEAF.txt_PANnum(driver).getText();
                                	   if (PAN_NUMBER.isEmpty()) {
										...
										System.out.println("Pan number is prefilled");
									}                                                  
                                                   
                                   }
                                   
                                   
                                   String NASCOM = PageObjectsEAF.txt_NSRITPINnum(driver).getText();
                                   ...
                                   Thread.sleep(3000);
                                   String drivingexpdate = PageObjectsEAF.dd_LicenseValidUpto(driver).getAttribute("value");
                                   ...
                                   Thread.sleep(3000);
                                   jse.executeScript("arguments[0].scrollIntoView()", PageObjectsEAF.txt_aadhaar_name(driver));
                                   Thread.sleep(2000);
...
//                                               
                ...
                */
                                                   ...
                                                   jse.executeScript("arguments[0].click();", PageObjectsEAF.txt_reasonforgap(driver));
                                                   Thread.sleep(2000);
                                                   
                                                   try {
                                                                if (PageObjectsEAF.visi_education_static1(driver).isDisplayed()) {
                                                                                   System.out.println(PageObjectsEAF.visi_education_static1(driver));
                                                                                   System.out.println(PageObjectsEAF.visi_education_static2(driver));
                                                                }
                                                } catch (Exception e) {
                                                                System.out.println("Static Message for Education Details Tab is not displayed");
                                                }
                                                                                   
                                                   jse.executeScript("arguments[0].click();", PageObjectsEAF.lnk_edu_details_visi(driver));
                                                   Thread.sleep(2000);
...
//                                              if(CGPA.isEmpty()){
                                      ...
                                      jse.executeScript("arguments[0].scrollIntoView()", PageObjectsEAF.dd_prgm_type(driver));
                                                  ...
                                                  try {
                                                        Alert alert = driver.switchTo().alert();
                                                        alert.accept();
                                                        wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.txt_date_diff_static(driver)));
                                                        System.out.println(PageObjectsEAF.txt_date_diff_static(driver));
...
//                                               Thread.sleep(2000);
                                                  ...
                                                  Thread.sleep(2000);
                                                  wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.chk_high_edu(driver)));
...
//                                                   String Qualification5 = PageObjectsEAF.dd_specialization_bpo(driver).getText();
...
//                                                   }
                                                   if (PageObjectsEAF.txt_other_specialization(driver).isEnabled() && PageObjectsEAF.txt_other_specialization(driver).isDisplayed() ) {
                                                	   PageObjectsEAF.txt_other_specialization(driver).clear();
                                                       PageObjectsEAF.txt_other_specialization(driver).sendKeys("qualification");
                                       				}
                                                   ...
                                                   jse.executeScript("arguments[0].scrollIntoView()", PageObjectsEAF.dd_specialization_bpo(driver));
...
//                                               PageObjectsEAF.txt_edu_period_from_ug6(driver).click();
                ...
                */
                                                   ...
                                                   if(Employment_Type.isEmpty()){
                                                                   ...
                                                                   if (data.emp_type.contains("Contract through third party")) {
                                                                                   try {
                                                                                        wait.until(ExpectedConditions.alertIsPresent());
                                                                                        Alert alert = driver.switchTo().alert();
                                                                                        if (alert.getText().contains("Please enter the employment details of your payroll company")) {
                                                                                               alert.accept();
                                                                                                                }                                                                                      
                                                                                    } catch (Exception e) {
                                                                                        System.out.println("Alert not present");
