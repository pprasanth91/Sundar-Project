...
public class EAF_ICF extends ExtendReports{
...
//				   
				...
				wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.lnk_edu_details_visi(driver)));
				   ...
				   String Specialization = PageObjectsEAF.dd_spec_icf(driver).getText();
				   System.out.println(Specialization);
				   if(Specialization.isEmpty()){
					   test.log(Status.INFO,"Entering the SSC Details - Specialization");
					   ...
					   PageObjectsEAF.dd_spec_icf(driver).sendKeys(data.edu1_spe);
					   }
				   ...
				   test.log(Status.INFO,"Entering the SSC Details - Affiliate To");
...
//				   String University_Name1 = PageObjectsEAF.dd_spec(driver).getText();
//				   System.out.println(University_Name1);
//				   if(University_Name1.isEmpty()){
					   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.txt_affili_to_icf(driver)));
					   test.log(Status.INFO,"Entering the HSC Details - Affiliated To");
					   PageObjectsEAF.txt_affili_to_icf(driver).clear();
...
//				   }
				  ...
				  System.out.println("Navigated to Edit Education Details tab");
				   ...
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.txt_insti_name_icf(driver)));
				   test.log(Status.INFO,"Entering the UG - Institution Name");
				   PageObjectsEAF.txt_insti_name_icf(driver).clear();
...
//				   }
				   ...
				   System.out.println(PageObjectsEAF.chk_current_emp(driver).getAttribute("checked"));
				   if((PageObjectsEAF.chk_current_emp(driver).getAttribute("checked") != null) || (PageObjectsEAF.chk_current_emp(driver).isSelected()) ){
					   System.out.println("Its the Current Employment");// if Checked 
				   }
					   
				   else{
				   wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.chk_current_emp(driver)));   
				   ...
				   if(Comp_Name.isEmpty()){
					  ...
					  // PageObjectsEAF.dd_comp_name_icf(driver).sendKeys(data.comp_name);
					   PageObjectsEAF.dd_comp_name_input(driver).sendKeys("a");
					   Thread.sleep(2000);
					   wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.dd_comp_name_input_select(driver)));
					   PageObjectsEAF.dd_comp_name_input_select(driver).click();
					     }
				   
				   Thread.sleep(2000);
				   String Comp_Name1 = PageObjectsEAF.dd_comp_name(driver).getAttribute("value");
				   System.out.println(Comp_Name1);
				   if(Comp_Name1.contains("Others")){
					   wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.txt_other_comp_name_icf(driver)));
					   PageObjectsEAF.txt_other_comp_name_icf(driver).clear();
					   PageObjectsEAF.txt_other_comp_name_icf(driver).sendKeys(data.other_comp_name);			   
				   }
...
//				   PageObjectsEAF.dd_emp_code_input_select(driver).click();				   
				   ...
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.txt_emp_code(driver)));
...
//				   }
				   wait.until(ExpectedConditions.visibilityOf(PageObjectsEAF.dd_pf_num(driver)));
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_pf_num(driver)));
				   PageObjectsEAF.dd_pf_num(driver).clear();
				   PageObjectsEAF.dd_pf_num(driver).sendKeys(data.pf_num);	
				   				   
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_reason_for_leaving(driver)));   
				   ...
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_reason_for_leaving_input_select(driver)));
				   PageObjectsEAF.dd_reason_for_leaving_input_select(driver).click();
				
				  
				   String reason_for_leaving = PageObjectsEAF.dd_reason_for_leaving(driver).getText();
				   System.out.println(reason_for_leaving);
				   if(reason_for_leaving.contains("Others")){
					   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_reason_for_leaving_input(driver)));
					   PageObjectsEAF.dd_reason_for_leaving_input(driver).clear();
					   PageObjectsEAF.dd_reason_for_leaving_input(driver).sendKeys(data.reason_for_leaving);
				   }
				   		   
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_mode_separation(driver)));   
				   ...
				   wait.until(ExpectedConditions.elementToBeClickable(PageObjectsEAF.dd_mode_separation_input_select(driver)));
				   PageObjectsEAF.dd_mode_separation_input_select(driver).click();
				  
				   
				   String Mode_Separation1 = PageObjectsEAF.dd_mode_separation(driver).getText();
